...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('controllers/', 'controllers/'), ('core/', 'core/'), ('effects/', 'effects/'), ('log/', 'log/'), ('resources/ico/', 'resources/ico/'), ('setup/', 'setup/'), ('views/', 'views/')],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('controllers/', 'controllers/'), ('core/', 'core/'), ('effects/', 'effects/'), ('log/', 'log/'), ('resources/ico/', 'resources/ico/'), ('utils/', 'utils/'), ('views/', 'views/')],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
